...
class ReorgStakeTest(PivxTestFramework):
    ...
    def check_money_supply(self, expected_piv):
        ...
        # verify that nodes have the expected ESP supply
        for node in g_info:
    ...
    def run_test(self):
        ...
        # Check ESP supply at the beginning
        # ------------------------------------------
        # ESP supply: block rewards minus burned fees for minting
        ...
        # Verify that ESP supplies were properly updated after the spends and reorgs
        self.log.info("Check ESP supply...")
