...
"""Verify that starting epsium with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start epsium with -? for help text")
        ...
        self.log.info("Start epsium with -version for version information")
