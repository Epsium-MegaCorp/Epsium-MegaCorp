...
{
    const char* pszTimestamp = "Epsium time!!!";
    const CScript genesisOutputScript = CScript() << ParseHex("044269de79be633632f41b55e2773ee721f9ca204db07880f6421ab57ca8e1ea93ed2a8e60ab5617c06d58aca0de98cb9055aa67fd6c2e5e46db81e5450e22a7fd") << OP_CHECKSIG;
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of
     (300, uint256S("0xe518337804c05718fdcc546f3cff8586cd3213c31932e72f6d50fe99810525d3"))
	 (700, uint256S("0xa45f6b70f26205f3a9ae8645afc1a583bbfaa9bd169086fc8558baac5cc4f0a9"))

;

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1703796817, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        //  uint32_t nGenesisTime = 1703668897;
        //  arith_uint256 test;
        //  bool fNegative;
        //  bool fOverflow;
        ...
        genesis = CreateGenesisBlock(1703668897, 361787, 0x1e0ffff0, 1, 0 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000007e866ca3b8b1d481331968337e3c4dd3e63e146f4901b8540ceca3796ee"));
        assert(genesis.hashMerkleRoot == uint256S("0x065955480724c8c2546a963078ba922fa0fe38d8ae3a3fa99697afa86d507123"));
        ...
        consensus.nMaxMoneyOut = 117600000 * COIN;
        ...
        // spork keys
        consensus.strSporkPubKey = "0440cc2cd736c0b9700f3f16bfd84b79096128ebe186adcc4f6abdde519aa94f9dfe3e6316df0ddfa304c1cd6825ad2241aa44e040b2c163b6308eeea25897b00a";
        ...
        vSeeds.push_back(CDNSSeedData("seed1", "seed1.epsium-megacorp.com"));
        vSeeds.push_back(CDNSSeedData("seed2", "seed2.epsium-megacorp.com"));
        vSeeds.push_back(CDNSSeedData("seed3", "seed3.epsium-megacorp.com"));
        vSeeds.push_back(CDNSSeedData("seed4", "seed4.epsium-megacorp.com"));
	    vSeeds.push_back(CDNSSeedData("seed5", "seed5.epsium-megacorp.com"));
	    vSeeds.push_back(CDNSSeedData("seed6", "seed6.epsium-megacorp.com"));
	    vSeeds.push_back(CDNSSeedData("seed7", "seed7.epsium-megacorp.com"));
	    vSeeds.push_back(CDNSSeedData("seed8", "seed8.epsium-megacorp.com"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 51);
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 63);
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 33);
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x45)(0x9D)(0xB0)(0x1F).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x45)(0x9D)(0x6E)(0xD7).convert_to_container<std::vector<unsigned char> >();
        // BIP44 coin type is from https://github.com/satoshilabs/slips/blob/master/slip-0044.md
        base58Prefixes[EXT_COIN_TYPE] = boost::assign::list_of(0x98)(0x21)(0xAF)(0xE7).convert_to_container<std::vector<unsigned char> >();
...
public:
    CTestNetParams()
    {
        ...
        consensus.powLimit   = ~UINT256_ZERO >> 20;   // epsium starting difficulty is 1 / 2^12
        consensus.posLimitV1 = ~UINT256_ZERO >> 24;
        consensus.posLimitV2 = ~UINT256_ZERO >> 20;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 65); // Testnet epsium addresses start with 'T'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 66);  // Testnet epsium script addresses start with 'T'
