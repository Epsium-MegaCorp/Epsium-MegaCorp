    ...
    ui(new Ui::DashboardWidget)
{
    ...
    // Staking Information
    ui->labelMessage->setText(tr("Amount of EPS earned via Staking & Masternodes"));
	...
	ui->labelAmountMNRewards->setText("0 EPS");
...
bool DashboardWidget::loadChartData(bool withMonthNames)
{
    ...
    chartData->amountsByCache = getAmountBy(); // pair EPS, zEPS
