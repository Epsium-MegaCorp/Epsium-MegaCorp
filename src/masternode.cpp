...
{
    if (nHeight > 1839600)	return 500000 * COIN;
    if (nHeight > 1576800)	return 250000 * COIN;
    if (nHeight > 1445400)	return 150000 * COIN;
    if (nHeight > 1314000)	return 120000 * COIN;
    if (nHeight > 1182600)	return 90000 * COIN;
    if (nHeight > 1051200)	return 60000 * COIN;
    if (nHeight > 963600)	return 50000 * COIN;
    if (nHeight > 876000)	return 40000 * COIN;
    if (nHeight > 788400)	return 30000 * COIN;
    if (nHeight > 700800)	return 25000 * COIN;
    if (nHeight > 613200)	return 20000 * COIN;
    if (nHeight > 525600)	return 18000 * COIN;
    if (nHeight > 481800)	return 16000 * COIN;
    if (nHeight > 438000)	return 15000 * COIN;
    if (nHeight > 394200)	return 14000 * COIN;
    if (nHeight > 350400)	return 13000 * COIN;
    if (nHeight > 306600)	return 12000 * COIN;
    if (nHeight > 262800)	return 11000 * COIN;
    if (nHeight > 219000)	return 10000 * COIN;
    if (nHeight > 175200)	return 9000 * COIN;
    if (nHeight > 131400)	return 8000 * COIN;
    if (nHeight > 87600)	return 7000 * COIN;
    if (nHeight > 43800)	return 6000 * COIN;
...
{
    if (nHeight > 2102400)	return 100 * COIN;
    if (nHeight > 1839600)	return 2000 * COIN;
    if (nHeight > 1576800)	return 1500 * COIN;
    if (nHeight > 1445400)	return 900 * COIN;
    if (nHeight > 1314000)	return 300 * COIN;
    if (nHeight > 1182600)	return 250 * COIN;
    if (nHeight > 1051200)	return 200 * COIN;
    if (nHeight > 963600)	return 90 * COIN;
    if (nHeight > 876000)	return 85 * COIN;
    if (nHeight > 788400)	return 80 * COIN;
    if (nHeight > 700800)	return 45 * COIN;
    if (nHeight > 613200)	return 40 * COIN;
    if (nHeight > 525600)	return 35 * COIN;
    if (nHeight > 481800)	return 25 * COIN;
    if (nHeight > 438000)	return 16 * COIN;
    if (nHeight > 394200)	return 15 * COIN;
    if (nHeight > 350400)	return 14 * COIN;
    if (nHeight > 306600)	return 13 * COIN;
    if (nHeight > 262800)	return 12 * COIN;
    if (nHeight > 219000)	return 11 * COIN;
    if (nHeight > 175200)	return 10 * COIN;
    if (nHeight > 131400)	return 9 * COIN;
    if (nHeight > 87600)	return 8 * COIN;
    if (nHeight > 43800)	return 6 * COIN;
    if (nHeight > 250)	    return 4 * COIN;
...
{
    return GetBlockValue(nHeight) * 75 / 100;
}
