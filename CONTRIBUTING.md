Contributing to Epsium Core
============================

The Epsium Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/EpsiumBF/Epsium/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Epsium Core project, and is not to be
confused with overall Epsium Network Protocol consensus changes.

Whether a pull request is merged into Epsium Core rests with the project merge
...
Patches that change Epsium consensus rules are considerably more involved than
...
Where a patchset proposes to change the Epsium consensus, it must have been
...
The project leader is the release manager for each Epsium Core release.
