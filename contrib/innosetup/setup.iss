...
#define MyAppName "Epsium"
#define MyAppPublisher "2022 Epsium developers"
#define MyAppURL "https://epsium-megacorp.com/"
#define MyAppExeName "epsium-qt.exe"
//#define MyAppExtraData "https://explorer.decenomy.net/bootstraps/EPS/bootstrap.zip"
...
OutputDir=.\output
OutputBaseFilename=EpsiumSetup
...
[Files]
Source: ".\package\epsium-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\Epsium\Epsium-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Epsium\Epsium-Qt,strDataDir|{userappdata}\Epsium\}');
  Result := True;
end;
